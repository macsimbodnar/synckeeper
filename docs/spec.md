...
- OAuth loopback flow with **S256 PKCE** — the client secret is public by design, so code-interception protection is load-bearing here, not ceremony *(adopted 2026-07-18, W1.9)*; token JSON at 0600, atomically replaced, auto-refreshed and re-persisted.
