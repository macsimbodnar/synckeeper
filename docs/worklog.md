...
- **Docs:** decisions.md "Security review" (records the gate; the four calls left to Max, not pre-decided); status.md (Updated + new Last-completed + Next promotes W5.5 to #1 + parked rotate line → W5.5-S1); this worklog entry. No code/spec/behavior change. Not committed yet (awaiting Max's go).
