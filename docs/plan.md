...
9. **[DOCS] Reconcile the testing.md N-row drift** — **done (2026-07-18)**, same session the plan was written: N1 and N3 have rows and IDs, the duplicate is deleted. Re-scoped remainder (2026-07-18, plan review): N3 passes on the dedup suite but has no named case — add `TestSnapshotDuplicateNameCollision` (`internal/remotedelta`, small test-only change) while W1.8's suite work is open anyway.
